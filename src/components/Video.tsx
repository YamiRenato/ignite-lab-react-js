          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-4 mt-6">
              <img
                ...
                src="https://github.com/YamiRenato.png"
                alt=""
              />

              <div className="leading-relaxed">
                <strong className="font-bold text-2xl block">Yami Renato</strong>
                <span className="text-gray-200 text-sm block">
                  Desenvolvedor apaixonado pela Stack Node.js, React.js e React Native.
                </span>
              </div>
            </div>
          </div>
